...
require(
  ...
  function (ec) {
    ...
    var option01 = {
      ...
      series: [
        ...
        },
        {
          ...
          markPoint: {
            data: [
              {name: 'Min of All', value : -2, xAxis: 1, yAxis: -1.5}
            ]
          },
          markLine: {
            data: [
    ...
    var option04 = {
      title: {
        text: 'ECharts Demo 04: Radar',
        subtext: 'Budget vs spending'
      },
      tooltip: {
        trigger: 'axis'
      },
    ...
    var option06 = {
      title: {
        text: 'ECharts Demo 06: Dashborad',
        subtext: 'demo',
      },
      tooltip: {
        formatter: "{a} <br/>{b} : {c}%"
    ...
    echart01.setOption(option01);
    echart02.setOption(option02);
    echart03.setOption(option03);
    echart04.setOption(option04);
    echart05.setOption(option05);
    /* echart06 */
    clearInterval(timeTicket);
    var timeTicket = setInterval(function () {
      option06.series[0].data[0].value = (Math.random() * 100).toFixed(2) - 0;
      echart06.setOption(option06, true);
    }, 2000);
